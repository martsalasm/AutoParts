    ...
    .then(data =>{
        ...
        ordenDetails.innerHTML = `
               ...
               <h2>Datos Cliente</h2>
                        ...
                        <h2>Productos:</h2>
                        <table border="0" cellpadding="10" cellspacing="0" style="width:100%; border-collapse:collapse; margin-top:20px; background-color:rgb(36,36,36); border-radius:5px;">
                            <thead>
                                <tr>
                                        <th>Producto</th>
                            ...
                            ${data.productos && data.productos.length > 0 ? 
                                data.productos.map(producto => `
                                    <td style="display: flex;align-items: center;gap: 10px;">
                                        <img src="${producto.url_imagen}" alt="${producto.nombre_producto}" style="width:50px; height:50px; object-fit:cover; align-self:center;">
